...
\hline
 0.1 & 28/06/2013 & all & 1st version & Cyril Cornu\\ \hline
 0.1 & 05/07/2013 & §1.3 &  Consistence with Project Quality Documentation & Merlin Pokam\\ \hline
 0.9 & 04/09/2015 & all &update according to final FPP & Fr\'ed\'erique~Vall\'ee, \newline Marc Behrens \\ \hline
 & & & & \\ \hline
 & & & & \\ \hline
\end{supertabular}
\egroup
...
\todo[inline]{revision until this point}
...
So far, the three CENELEC standards (CENELEC) have been identified as defining the normative frame for the EVC Software development. Due to the scope of the development as described inside the FPP \cte{FPP} only the CENELEC EN 50128 is applicable for the assessment.
