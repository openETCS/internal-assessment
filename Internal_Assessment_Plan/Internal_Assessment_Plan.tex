...
So far, the three CENELEC standards (CENELEC) have been identified as defining the normative frame for the EVC Software development. Due to the scope of the development as described inside the FPP \cite{FPP} only the CENELEC EN 50128 is applicable for the assessment.
