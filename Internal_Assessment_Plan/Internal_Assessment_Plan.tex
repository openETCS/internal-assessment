...
For each assessment activities, this assessment plan will identify the relevant deliverables, and the criteria that will be considered for the assessment.
The Internal Assessment Plan shall provide and detail the following aspects: 
\begin{itemize}
\item All versions of the present Assessment Plan and modification tracking are provided in the part 1.3 of this document.
\item Authors of this document are:
	\begin{itemize}
	\item Cyril Cornu (All4tec) is the Internal Assessment Activity Organizer. 
	\item Frederique Vallee (All4tec) is an Internal Assessor for Open ETCS project
...
According to the CENELEC standards, the Independant External Assessor has to get the agreement signature for submission of the customer (here open ETCS project) to the assessor expectations according to the EN45001 standard, defining the juridical and technical standard for an independent evaluating structure.
This point is major because it defines precisely the difference between the Internal Assessment Task
...
The documents have to be identified in this process, and the connection  between the activities to be performed and the related document shall be provided.
...
\item The coherency of applied technics and methods to the Quality Assurance Plan;
\item ...
\end{itemize}
