...
\include{contractinformation}\cleardoublepage
\include{general}\cleardoublepage
\include{introduction}\cleardoublepage
\include{expertassessment}\cleardoublepage
\include{answerstoquestions}\cleardoublepage
\include{summary}\cleardoublepage
\include{finalization}\cleardoublepage

% show only documents cited
%\nocite{*} 

\bibliographystyle{plain}
\bibliography{Assessment_Report}
